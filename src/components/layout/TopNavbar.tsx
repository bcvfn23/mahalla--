...
export default function TopNavbar() {
  ...
  const toggleTheme = () => {
    setIsDark(!isDark);
    toast.success(lang === 'uz' ? "Mavzu o'zgartirildi" : "Тема изменена");
  };
            ...
            <div className="relative" ref={notifRef}>
              ...
              {showNotifications && (
                <div className="absolute top-full right-0 mt-2 w-80 bg-[#091024] border border-card-border rounded-2xl shadow-xl overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  <div className="p-4 border-b border-card-border/50 hover:bg-card/50 transition-colors cursor-pointer">
